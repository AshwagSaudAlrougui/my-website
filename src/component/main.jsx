...
<i  id='x' class="fa fa-phone" style={{color:'green',fontSize:'14px'}}>+966553465261</i> <p></p>
{/* <i class="fa fa-home" aria-hidden="true"style={{marginLeft:'-512px',color:'black'}}></i>{'c'} */}
<i class="fa fa-map-marker" aria-hidden="true"style={{textAlign:'left',color:'grey',fontSize:'14px'}}>{'  '}KSA,Riyadh</i>{' '}
